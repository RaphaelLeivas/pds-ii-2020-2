...
class FilaPrioridade {
  private:
    No* _cabeca; // Ponteiro para o primeiro elemento da lista (as vezes chamado de cabeça) 
	  int _tamanho;
  ...
  public:
     ...
     * o que está no índice n, assumindo que o primeiro índice é 0.
       @retorna o DADO do elemento do meio da lista.
     */
    unsigned getMeio();
    /** Retorna o dado do nó do último elemento da lista (o nó com menor prioridade (maior inteiro)).
       @retorna o inteiro armazenado como DADO no último nó da lista.
     */
    unsigned getUltimo();
    ...
    void print(); // deve printar SOMENTE OS DADOS!
    No* getCabeca();
